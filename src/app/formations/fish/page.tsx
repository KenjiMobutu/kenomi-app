...
interface SearchParamsHandlerProps {
  onRidReceived: (rid: string) => void;
}

// Separate component that uses useSearchParams
function SearchParamsHandler({ onRidReceived }: SearchParamsHandlerProps) {
...
function PhishingContent() {
  ...
  const handleRidReceived = (rid: unknown) => {
    fetch('/api/track', {
      method: 'POST',
  ...
  return (
    <div className={`page ${visible ? 'fade-in' : 'fade-out'}`}>
      <Suspense fallback={null}>
        <SearchParamsHandler onRidReceived={handleRidReceived} />
      </Suspense>
